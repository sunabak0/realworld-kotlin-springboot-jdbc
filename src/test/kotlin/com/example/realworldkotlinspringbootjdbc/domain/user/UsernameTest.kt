...
class UsernameTest {
    ...
    fun Userのusernameは4文字以上(
        ...
        Assertions.assertThat(invalid).isEqualTo(Username.ValidationError.TooShort(invalidUsername).invalidNel())
    ...
    fun Userのusernameは32文字以下(
        ...
        Assertions.assertThat(invalid).isEqualTo(Username.ValidationError.TooLong(invalidUsername).invalidNel())
        Assertions.assertThat(valid).isEqualTo(Unit.valid())
    }
}
