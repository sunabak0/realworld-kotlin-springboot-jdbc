...
class ImageTest {
    ...
    fun `Userのimageは512文字以下`(
        ...
        Assertions.assertThat(invalid).isEqualTo(Validated.Invalid(Image.ValidationError.TooLong(invalidImage)))
        Assertions.assertThat(valid).isEqualTo(Validated.Valid(validImage))
    }
}
